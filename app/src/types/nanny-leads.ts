...
export type FunnelAction =
  ...
  | { type: 'UPDATE_CONTACT'; payload: Partial<Pick<NannyLeadFunnelState, 'first_name' | 'last_name' | 'email' | 'phone'>> }
...
export const PERSONALITY_TRAIT_OPTIONS = [
  'Patient', 'Creative', 'Energetic', 'Nurturing', 'Calm',
  'Organised', 'Warm', 'Reliable', 'Adaptable', 'Empathetic',
  'Playful', 'Attentive',
];
...
export const MIN_AGE_OPTIONS = [
  'Newborn', '3 months', '6 months', '12 months', '18 months',
  '2 years', '3 years', '5 years', '10 years',
];

export const MAX_AGE_OPTIONS = [
  '12 months', '3 years', '5 years', '10 years', '13 years', '16 years',
];
...
export const PAY_FREQUENCY_OPTIONS = ['Daily', 'Weekly', 'Fortnightly', 'Monthly'];
